...
let bar = new Person2('bar',33,'women');
console.log(typeof bar); //그러나 생성자 함수를 쓰면 객체(object)가 된다
console.dir(bar);

let baz = new Person2('baz',25,'women');
...
bar = new Person3('bar', 33, 'women');
baz = new Person3('baz' , 25 , 'women');
...
class Car {
  ...
  get_userGear() {return this._uerGear;}
  set_userGear(gear) {
